...
export const metadata: Metadata = {
  title: 'Ортофит | О нас',
  description:
    'Ортофит - разработка реабилитационного оборудования: тренажёр FITRoller для инвалидных колясок, подъёмное кресло Унилифт. Решения для активной реабилитации, ухода за маломобильными пациентами, адаптивной физкультуры. Профессиональные подъёмники, кресла-туалеты, тренажёры для ЛФК. Доставка по России, поддержка пользователей, оборудование для домов престарелых и медицинских центров.',
}
        ...
        <Container>
          ...
          <div className='text-[18px] lg:pr-[163px]'>
            ...
            <ul className='mt-[28px] list-disc pl-[20px] font-light'>
              ...
              <li>
                {' '}
                ухаживающий персонал улучшать качество жизни дома и в профессиональных учреждениях
              </li>
            </ul>
