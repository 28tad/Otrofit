...
export const metadata: Metadata = {
  ...
  description:
    'Ортофит - Профессиональные решения: тренажёр ОРТОФИТ РОЛЛЕР для колясочников и подъёмное кресло Унилифт. Помогаем восстановить mobility и самостоятельность. Доставка по России.',
}
