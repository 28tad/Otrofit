...
export const equipmentData: Record<EquipmentKey, EquipmentRow> = {
  ...
  [EQUIPMENT_KEYS.GANTRY_M]: {
    data: gantry,
    title: 'Ортофит | Подвес мобильный Ассистент',
    description:
      'Ортофит - Подвес мобильный Ассистент - мобильная П-образная стойка для подъёма пациента из кровати и безопасной пересадки в инвалидную коляску',
  },
  [EQUIPMENT_KEYS.GANTRY_E]: {
    data: adyutorElectric,
    title: 'Ортофит | Ассистент Электра',
    description:
      'Ортофит - Подвес мобильный Ассистент Электра - мобильная П-образная стойка для подъёма пациента из кровати и безопасной пересадки в инвалидную коляску',
  },
