  ...
  blocks: [
    {
      ...
      story: {
        ...
        content: (
          <>
            Кресло-трансформер для позиционирования, ухода и безопасного переложения пациента.
            Принимает три стабильных положения и оснащено откидными боковыми створками («крыльями»)
            — они опускаются вровень с плоскостью кресла, чтобы быстро переложить лежачего пациента
            на/с кровати.
          </>
        ),
      },
      ...
      list: {
        ...
        items: [
          ...
          'Откидные боковые створки («крылья») для бокового переложения с кроватью',
...

    {
      ...
      content: (
        <>
          <b>Ортофит Кресло-трансформер</b> помогает быстро менять положение пациента из лежачего в
          сидячее и обратно, проводить процедуры и выполнять безопасные пересадки. Откидные «крылья»
          формируют широкое боковое окно к матрасу — кресло подводится вплотную, тормоза
          фиксируются, дальше выполняется перенос.
        </>
      ),
    },

    {
      ...
      content: (
        <>
          <b>Режимы работы.</b> Полностью вертикальное положение — для вертикализации и коротких
          упражнений; «приподнятая спинка + вертикальные ноги» — удобно для работы с нижними
          конечностями; «приподнятая спинка + опущенные ноги» — комфортно для кормления и общения.
        </>
      ),
    },
...

    {
      ...
      items: [
        'Реабилитационные центры, отделения ЛФК и физиотерапии',
        'Долгосрочный и паллиативный уход, стационары',
        'Домашний уход после травм и операций',
        'Кабинеты перевязок, массажа, процедурные',
      ],
    },

    {
      ...
      items: [
        ...
        <>
          ...
          для быстрого переложения с кровати и обратно.
        </>,
        <>
