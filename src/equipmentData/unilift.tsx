      ...
      left: [
        {
          ...
          content: (
            <>
              ...
              <span className='font-bold'>Унилифт</span>, рассчитанная на рабочую нагрузку до 120
        ...
        },
        {
          ...
          content: (
            <>
              Удобные ручки устройства позволяют использовать его не только как автономное
              санитарное кресло, но и также для вертикализации и перемещения пациента с помощью
