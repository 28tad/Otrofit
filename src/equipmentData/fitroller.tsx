  ...
  blocks: [
    {
      ...
      story: {
        ...
        content: (
          <>
            <span className='font-bold'>Тренажёр для колясочной езды ОРТОФИТ РОЛЛЕР —</span>
    ...
    },
    {
      ...
      content: (
        <>
          ...
          <span className='font-bold'>ОРТОФИТ РОЛЛЕР</span>, рассчитанная на рабочую нагрузку до 150
